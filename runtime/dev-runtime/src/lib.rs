...
// Imports for the no_std environment support
use sp_std::prelude::*; 

// Imports contract_pallet configuration
mod contracts_config;

// Import basic types and traits for consensus mechanisms and the runtime API.
use pallet_grandpa::AuthorityId as GrandpaId; 
use sp_consensus_aura::sr25519::AuthorityId as AuraId;
use sp_core::{crypto::KeyTypeId, OpaqueMetadata};
use sp_api::impl_runtime_apis;

// Import types for block structure, transactions and signatures. 
use sp_runtime::{
...
// CONDITIONAL COMPILATION FOR THE std ENVIRONMENT
#[cfg(feature = "std")]
// Import version information for the runtime
use sp_version::NativeVersion;  // std
use sp_version::RuntimeVersion; // wasm

// Import Support functions and structures from frame_support
...
// TYPE DEFINITION FOR THE RUNTIME
...
// Opaque types for CLI interaction.
/// These are used by the CLI to instantiate machinery that don't need to know the specifics of the runtime.
...
// RUNTIME VERSION CONFIGURATION INFORMATION 
...
// Time management in the blockchain
...
// Currency LOST definition 
pub const MICROLOST: Balance = 1_000_000_000;
...
impl frame_system::Config for Runtime {
	...
	/// The omnipresent origin type.
	type RuntimeOrigin = RuntimeOrigin;
	/// The omnipresent event type.
...
// Use this macro to define the runtime structure and to compose the pallets.
